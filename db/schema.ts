...
export const scores = mysqlTable("scores", {
  ...
  k5Score: decimal("k5_score", { precision: 5, scale: 2 }),
  k1Utility: decimal("k1_utility", { precision: 5, scale: 2 }),
  k2Utility: decimal("k2_utility", { precision: 5, scale: 2 }),
  k3Utility: decimal("k3_utility", { precision: 5, scale: 2 }),
  k4Utility: decimal("k4_utility", { precision: 5, scale: 2 }),
  k5Utility: decimal("k5_utility", { precision: 5, scale: 2 }),
  totalScore: decimal("total_score", { precision: 5, scale: 2 }),
  ranking: int("ranking"),
  grade: mysqlEnum("grade", ["sangat_baik", "baik", "cukup", "buruk"]),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow().onUpdateNow(),
});
