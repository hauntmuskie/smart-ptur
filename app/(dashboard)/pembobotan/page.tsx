  ...
  return (
    <TableRow>
      ...
      <TableCell className="pr-4 text-center sm:pr-0">
        <ScoreForm employee={emp} existingScore={empScore} />
      </TableCell>
    </TableRow>
  );
}
...
export default async function PembobotanPage() {
  const { employeeList, criteriaList, scoreList } = await getData();
      ...
      <Card>
        <CardHeader className="p-4 sm:p-6">
          ...
          <CardDescription className="text-xs sm:text-sm">
            Skala penilaian: Sangat Baik (90-100), Baik (80-89), Cukup (66-79),
            Buruk (&lt;65)
          </CardDescription>
        </CardHeader>
        <CardContent className="p-0 sm:p-6 sm:pt-0">
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[80px] pl-4 sm:pl-0">Kode</TableHead>
